...
\begin{itemize}
    ...
    \item \textbf{Phát hiện theo chữ ký/IOC:} xây dựng bộ phân tích cú pháp cho một tập con cú pháp kiểu Suricata và kiểm tra các mẫu IOC như domain blacklist, User-Agent hoặc payload pattern đã biết.
...
\begin{itemize}
    ...
    \item Phần chữ ký hỗ trợ một \textit{Suricata-style subset}, đủ cho các tình huống demo như SQL Injection, nhận diện \texttt{sqlmap} và khớp domain IOC mẫu.

...
Số liệu dưới đây được lấy từ file \texttt{data/alerts\_saved\_20260624\_001342.jsonl}. File này lưu 5 cảnh báo thực nghiệm; file \texttt{data/alerts.jsonl} tại thời điểm kiểm tra đang rỗng.
...
\begin{table}[H]
    ...
    \begin{tabular}{|>{\raggedright\arraybackslash}p{2.3cm}|>{\raggedright\arraybackslash}p{2.0cm}|>{\raggedright\arraybackslash}p{2.1cm}|>{\raggedright\arraybackslash}p{3.2cm}|>{\raggedright\arraybackslash}p{3.4cm}|}
        ...
        Port scan & RULE-001 & 2 alerts & unique ports = 20, count = 20 & Hai lần vượt ngưỡng scan. \\ \hline
        ...
        HTTP signature & \texttt{custom.rules} & 0 alert trong file lưu & -- & Không có dòng HTTP signature trong file alert đã lưu. \\ \hline
    \end{tabular}

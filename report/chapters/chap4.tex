...
\begin{itemize}
    ...
    \item Luật signature phát hiện các chuỗi đặc trưng trong HTTP hoặc payload thô.
...
\begin{table}[H]
    ...
    \begin{tabular}{|>{\raggedright\arraybackslash}p{2.3cm}|>{\raggedright\arraybackslash}p{2.0cm}|>{\raggedright\arraybackslash}p{2.1cm}|>{\raggedright\arraybackslash}p{3.2cm}|>{\raggedright\arraybackslash}p{3.4cm}|}
        ...
        DNS tunneling & RULE-004 & TODO: điền số thực tế & query, reason counts, count & $\geq$ 5 suspicious queries/30 giây. \\ \hline
